...
def create_app():
    ...
    app.config['MYSQL_DATABASE_DB'] = 'BurrowConnect'  # Change this to your DB name
    ...
    from src.experienceproviders import experienceproviders
    ...
    app.register_blueprint(experienceproviders, url_prefix='/e')
